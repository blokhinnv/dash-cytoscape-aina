export default class cyResponsive {
    ...
    resize() {
        ...
        const xConstrained = Math.abs(1 - curr.width / prev.width) > Math.abs(1 - curr.height / prev.height);
            ...
            if (fullyContained) {
                const maxContainedZoom =
                    Math.min(
                        ...
                        (-(curr.renderedBB.y1 + curr.renderedBB.h / 2 - prev.height) * prev.zoom * 2) /
                            curr.renderedBB.h
                ...
                while (Math.abs(currrentState) <= 1) {
                    ...
                    if (currrentState === -1) {
                        const intermediateTargetZoom = targetState === 1 ? maxContainedZoom : targetZoom;
                        ...
                        const intermediateTargetWidth = targetState === -1 ? maxContainedWidth : curr.width;
            ...
            if (fullyContained) {
                ...
                while (Math.abs(currrentState) <= 1) {
                    ...
                    if (currrentState === -1) {
                        ...
                        const intermediateTargetHeight = targetState === -1 ? maxContainedHeight : curr.height;
